...
<div>
  ...
  <div className="col">
    <div className="card">
      <img src="https://picsum.photos/id/1/100" className="card-img-top" alt="card2"/>
      <div className="card-body">
        <h5 className="card-title">Card title</h5>
        <p className="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      </div>
  ...
  <div className="col">
    <div className="card">
      <img src="https://picsum.photos/id/1/100" className="card-img-top" alt="card3"/>
      <div className="card-body">
        <h5 className="card-title">Card title</h5>
  ...
  <div className="col">
    <div className="card">
      <img src="https://picsum.photos/id/1001/100" className="card-img-top" alt="card4"/>
      <div className="card-body">
        <h5 className="card-title">Card title</h5>
        <p className="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      </div>
